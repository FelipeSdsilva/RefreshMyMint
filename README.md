...
- [x] ```(4)Fazer um programa para ler dois valores inteiros X e Y, e depois mostrar na tela o valor da soma destes números. ```
...
- [x] ```(2) Faça um programa para ler um número indeterminado de dados, contendo cada um, a idade de um
...
- [x] ```(3) Escreva um programa que repita a leitura de uma senha até que ela seja válida. Para cada leitura de
...
- [x] ```(5) Faça um programa que leia as notas referentes às duas avaliações de um aluno. Calcule e imprima a
...
- [x] ```(6)Um posto de combustíveis deseja determinar qual de seus produtos tem a preferência de seus clientes.
...
- [x] ```(7) O programa deve ler um valor inteiro X indefinidas vezes. (O programa irá parar quando o valor de X
...
- [x] ```(2) Leia 2 valores inteiros X e Y (em qualquer ordem). A seguir, calcule e mostre a soma dos números
impares entre eles. ```
...
- [x] ```(3) Leia um valor inteiro X. Em seguida mostre os ímpares de 1 até X, um valor por linha, inclusive o X,
se for o caso.```
...
- [x] ```(4) Leia um valor inteiro N. Este valor será a quantidade de valores inteiros X que serão lidos em seguida.
...
- [x] ```(5) Leia um valor inteiro N. Este valor será a quantidade de números inteiros que serão lidos em seguida.
...
- [x] ```(6) Leia um valor inteiro N, que representa o número de casos de teste que vem a seguir. Cada caso de
...
- [x] ```(7) Escreva um algoritmo que leia um número inteiro N, e depois repita N vezes: ler dois números e
...
- [x] ```(8)Fazer um programa para ler um número natural N (valor máximo: 15), e depois calcular e mostrar o
fatorial de N. ```
...
- [x] ```(9) Maria acabou de iniciar seu curso de graduação na faculdade de medicina e precisa de sua ajuda para
...
- [x] ```(10) Ler um número inteiro N e calcular todos os seus divisores```
...
- [x]```(11) Fazer um programa para ler um número inteiro positivo N. O programa deve então mostrar na tela N linhas, 
...
- [x] ```(9) Fazer um programa para ler um conjunto de nomes de pessoas e suas respectivas
...
- [x] ```(10) Fazer um programa para ler um conjunto de N nomes de alunos, bem como as
...
- [x] ```(11) Tem-se um conjunto de dados contendo a altura e o gênero (M, F) de N pessoas.
