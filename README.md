...
## Exercices While
- [ ] ```(1) Leia uma quantidade indeterminada de duplas de valores inteiros X e Y. Escreva para cada X e Y uma 
...
- [ ] ```(2) Faça um programa para ler um número indeterminado de dados, contendo cada um, a idade de um 
...
Exemplo 2: 
	...
	-10 
	IMPOSSIVEL CALCULAR
- [ ] ```(3) Escreva um programa que repita a leitura de uma senha até que ela seja válida. Para cada leitura de 
...
Exemplo: 
	...
	Acesso permitido! 
- [ ] ```(4) Escreva um programa para ler as coordenadas (X,Y) de uma quantidade indeterminada de pontos no 
...
Exemplo: 
	...
	0 
	2
- [ ] ```(5) Faça um programa que leia as notas referentes às duas avaliações de um aluno. Calcule e imprima a 
...
Exemplo 2: 
	...
	MEDIA = 6.75 
- [ ] ```(6)Um posto de combustíveis deseja determinar qual de seus produtos tem a preferência de seus clientes. 
...
Exemplo: 
	...
	Gasolina: 2 
	Diesel: 0 
- [ ] ```(7) O programa deve ler um valor inteiro X indefinidas vezes. (O programa irá parar quando o valor de X 
...
- [ ] ```(8) Fazer um programa para ler uma temperatura em Celsius e mostrar o equivalente em Fahrenheit.
...
## Exercices For
- [ ] ```(1) Ler um número inteiro N, daí mostrar na tela a tabuada de N para 1 a 10, conforme exemplo. ```
...
Exemplo: 
	...
	4 x 9 = 36 
	4 x 10 = 40 
- [ ] ```(2) Leia 2 valores inteiros X e Y (em qualquer ordem). A seguir, calcule e mostre a soma dos números 
impares entre eles. ```
...
Exemplo 3: 
	...
	-5
	SOMA DOS IMPARES = 5 
- [ ] ```(3) Leia um valor inteiro X. Em seguida mostre os ímpares de 1 até X, um valor por linha, inclusive o X, 
se for o caso.```
...
Exemplo: 
	...
	5 
	7
- [ ] ```(4) Leia um valor inteiro N. Este valor será a quantidade de valores inteiros X que serão lidos em seguida. 
...
Exemplo: 
	...
	2 DENTRO 
	3 FORA
- [ ] ```(5) Leia um valor inteiro N. Este valor será a quantidade de números inteiros que serão lidos em seguida. 
...
Exemplo: 
	...
	Digite um numero: -4
	PAR NEGATIVO 
- [ ] ```(6) Leia um valor inteiro N, que representa o número de casos de teste que vem a seguir. Cada caso de 
...
Exemplo: 
	...
	10.0 
	MEDIA = 9.3 
- [ ] ```(7) Escreva um algoritmo que leia um número inteiro N, e depois repita N vezes: ler dois números e 
...
Exemplo: 
	...
	DIVISAO = 0.00 
- [ ] ```(8)Fazer um programa para ler um número natural N (valor máximo: 15), e depois calcular e mostrar o 
fatorial de N. ```
...
Exemplo 1: 
	...
	FATORIAL = 24 
- [ ] ```(9) Maria acabou de iniciar seu curso de graduação na faculdade de medicina e precisa de sua ajuda para 
